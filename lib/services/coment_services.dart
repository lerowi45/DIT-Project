...
// Get post comments
Future<ApiResponse> getComments(int eventId) async {
  ApiResponse apiResponse = ApiResponse();
  try {
    String token = await getToken();
    final response = await http.get(Uri.parse('$eventsURL/$eventId/comments'),
        headers: {
...
// Create comment
Future<ApiResponse> createComment(int eventId, String? comment) async {
  ApiResponse apiResponse = ApiResponse();
  try {
    String token = await getToken();
    //print("got here");

    final response = await http.post(Uri.parse('$eventsURL/$eventId/comments'),
        headers: {
          'Accept': 'application/json',
          'Authorization': 'Bearer $token'
        },
